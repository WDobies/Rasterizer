...
DirectionalLightGourad::DirectionalLightGourad()
{
}

DirectionalLightGourad::DirectionalLightGourad(Vector3 position, Vector3 ambient, Vector3 diffuse, Vector3 specular, int shininess, float specularStrenght)
{
...
void DirectionalLightGourad::Calculate(Mesh& mesh)
{
...
Vector3 DirectionalLightGourad::CalculatePhong(Triangle& triangle)
{
